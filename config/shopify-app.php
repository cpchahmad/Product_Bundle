...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Product Bundles'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '2e6f87dc5b1cfcb57e6bd0d36f63d86c'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_inventory,write_inventory, read_products,write_products,read_orders,write_orders,read_draft_orders, write_draft_orders'),
